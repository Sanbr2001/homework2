...
public class App {
    public static void main(String[] args) {
        ...
        boolean helloWorldComparison = (helloWorld1 == helloWorld2);
        boolean catComparison = (cat1 == cat2);

        System.out.println("Comparison for HelloWorld beans: " + helloWorldComparison);
        System.out.println("Comparison for Cat beans: " + catComparison);
    }
}
